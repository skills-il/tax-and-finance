...
## מלכודות נפוצות
- בנקים ישראליים משתמשים בתקן "בנקאות פתוחה" של בנק ישראל, לא בתקן PSD2 האירופי. סוכנים עלולים להפנות ל-APIs של PSD2 או Open Banking בריטי שלא קיימים בישראל.
