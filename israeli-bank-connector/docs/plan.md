# Israeli Bank Connector Skill — Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Build a skill that enhances the existing Israeli bank MCP servers with workflow guidance for transaction analysis, spending patterns, and financial aggregation across Israeli banks and credit card companies.

**Architecture:** MCP Enhancement skill (Category 3). Enhances `israeli-bank-mcp`, `il-bank-mcp`, and `asher-mcp` with financial analysis workflows and best practices.

**Tech Stack:** SKILL.md, references for bank API capabilities, financial analysis patterns.
...
- **israeli-bank-mcp** (Motti Bechhofer): Supports Hapoalim, Leumi, Discount, Mercantile, Mizrahi, Otsar Hahayal + credit cards (Visa Cal, Max, Isracard, Amex) via `israeli-bank-scrapers` library with 2FA
- **il-bank-mcp** (Gal Lekner): Docker-based, adds transaction analysis and spending pattern tracking
- **Asher MCP**: Another interface to the same scraper ecosystem

### Israeli Banking Landscape
- **Major Banks:** Hapoalim, Leumi, Discount (merged Mercantile), Mizrahi-Tefahot, FIBI
- **Credit Cards:** Visa Cal, Max (formerly Leumi Card), Isracard, American Express Israel
- **Open Banking:** Bank of Israel regulation evolving but not standardized yet
- **No Plaid equivalent** in Israel — scrapers are the primary automation method

### Use Cases
1. **Transaction categorization** — Classify spending by category across accounts
2. **Spending analysis** — Monthly summaries, trends, budget vs actual
3. **Multi-bank aggregation** — Unified view across all Israeli banks
4. **Recurring payment detection** — Identify subscriptions and recurring charges
5. **Tax preparation** — Export categorized transactions for accountant/SHAAM
...
Result: Categorized pie chart data with NIS amounts per category, top merchants, and comparison to December.
