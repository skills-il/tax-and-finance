...
- [ ] Document-type triage: only tax invoices (300/305) grant input VAT; receipt (320), proforma (330), credit invoice (310) handled distinctly, source: §38 VAT Law 5736-1975. [covered]
...
- [ ] Input-VAT eligibility gates: invoice issued in the claiming business's name (על שם העוסק), actually held by the claimant, and within the 6-month deduction window (later needs VAT-office approval), source: §38 VAT Law; תקנה 23א. [covered v1.3.0]

- [ ] Blocked / partial input VAT: hospitality/entertainment (אירוח) blocked (תקנה 16, except foreign guest); non-commercial vehicle running costs 2/3, purchase VAT non-deductible (תקנה 14); mixed taxable/exempt apportionment 2/3 or 1/4 (תקנה 18), source: VAT Regulations 1976. [אירוח + vehicle purchase now enforced in the script v1.3.0; תקנה 18 apportionment still to add]

- [ ] SHAAM allocation number (מספר הקצאה) required above the issue-date threshold (20k 2025 / 10k Jan-2026 / 5k Jun-2026, further cuts planned 2027) or input VAT is disallowed, source: Israel Invoice Model, gov.il digital-invoices. [covered]
...
- [ ] Expense categorization into the 12 working categories aligned with the Tax Authority income-statement structure (form 6111), with income-tax caps (entertainment/כיבוד, depreciation schedule), source: Income Tax Ordinance; ITA allowed-expenses guide. [covered]
