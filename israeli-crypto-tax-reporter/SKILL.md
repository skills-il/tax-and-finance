...
- **A new immigrant or returning resident may hold a 10-year exemption on foreign-acquired crypto (Section 14).** Under Section 14(a) an oleh chadash or toshav chozer vatik is exempt for 10 years, from the date of becoming an Israeli resident, on income and capital gains sourced from assets held abroad, which can reach crypto acquired before aliyah. The FIFO calculator here does NOT model this and will overstate tax on such lots. For any oleh or returning-resident scenario, flag Section 14 and route the user to a CPA (and the aliyah/relocation skills) before producing a plain disposal figure.
