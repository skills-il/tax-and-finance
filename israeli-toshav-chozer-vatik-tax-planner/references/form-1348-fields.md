...
3. **Form 2409** - bank-level declaration of toshav chozer status. Israeli banks typically request this form in connection with an incoming foreign-currency deposit. Any deadline is a bank convention, NOT a statute, so check the specific bank's policy rather than relying on a stated number.
